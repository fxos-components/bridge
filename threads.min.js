...
"message",function n(b){"load"==b.data&&b.source==e&&(window.removeEventListener("message",n),d.resolve())});return d.G}}}()},{"../utils":7}],6:[function(l,f){function d(e){if(!(this instanceof d))return new d(e);k.K.call(this,e);this.clients={};this.methods={};this.b("_disconnect",this.onDisconnect.bind(this)).b("_connect",this.ha.bind(this)).b("_method",this.ia.bind(this)).b("_off",this.ja.bind(this)).b("_on",this.ka.bind(this));this.g=this.g.bind(this)}function g(e){return Error({4:'method "'+
[].slice.call(arguments,1)[0]+"\" doesn't exist"}[e])}var m=l("./utils").J,k=l("./message"),h=k.K;f.h=d;d.prototype=Object.create(h.prototype);d.prototype.method=function(e,b){this.methods[e]=b;return this};d.prototype.X=function(e,b,c){var a=this;this.Y(function(d){c&&!~c.indexOf(d.id)||a.push(e,b,d.id,{f:!0})});return this};d.prototype.push=function(e,b,c,a){a=a&&a.f;var d=this.$(c);return k("_push").set({s:c,f:a,data:{type:e,data:b}}).send(d.port)};d.prototype.Y=function(e){for(var b in this.clients)e(this.clients[b])};
d.prototype.$=function(e){return this.clients[e]};d.prototype.ha=function(e){var b=e.data,c=b.B;if(c&&b.v===this.name&&!this.clients[c]&&(this.a("before-connect",e),!e.defaultPrevented)){if(b=(b=e.event.ports)&&b[0])e.S(b),this.l(b),b.start();this.V(c,e.H);e.u();this.a("connected",c)}};d.prototype.onDisconnect=function(e){var b=this.clients[e.data];b&&(this.a("before-disconnect",e),e.defaultPrevented||(this.R(b.id),e.u(),this.a("disconnected",b.id)))};d.prototype.ia=function(e){this.a("before-method",
e);if(!e.defaultPrevented){var b=e.data,c=b.name,a,d=this.methods[c];if(!d)throw g(4,c);try{a=d.apply(this,b.W)}catch(f){a=f}e.u(a)}};d.prototype.ka=function(e){this.a("on",e.data)};d.prototype.ja=function(e){this.a("off",e.data)};d.prototype.V=function(e,b){this.clients[e]={id:e,port:b}};d.prototype.R=function(e){delete this.clients[e]};d.prototype.F=function(e){e(this,{uuid:m});return this};d.prototype.disconnect=function(e){this.R(e.id);k("disconnect").set({s:e.id,f:!0}).send(e.port)};d.prototype.g=
