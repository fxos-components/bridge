var $jscomp={scope:{},global:this},Symbol;$jscomp.initSymbol=function(){$jscomp.global.Symbol||(Symbol=$jscomp.Symbol);$jscomp.initSymbol=function(){}};$jscomp.symbolCounter_=0;$jscomp.Symbol=function(e){return"jscomp_symbol_"+e+$jscomp.symbolCounter_++};$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();Symbol.iterator||(Symbol.iterator=Symbol("iterator"));$jscomp.initSymbolIterator=function(){}};
$jscomp.makeIterator=function(e){$jscomp.initSymbolIterator();if(e[Symbol.iterator])return e[Symbol.iterator]();if(!(e instanceof Array||"string"==typeof e||e instanceof String))throw new TypeError(e+" is not iterable");var f=0;return{next:function(){return f==e.length?{done:!0}:{done:!1,value:e[f++]}}}};$jscomp.arrayFromIterator=function(e){for(var f,k=[];!(f=e.next()).done;)k.push(f.value);return k};$jscomp.arrayFromIterable=function(e){return e instanceof Array?e:$jscomp.arrayFromIterator($jscomp.makeIterator(e))};
$jscomp.arrayFromArguments=function(e){for(var f=[],k=0;k<e.length;k++)f.push(e[k]);return f};$jscomp.inherits=function(e,f){function k(){}k.prototype=f.prototype;e.prototype=new k;e.prototype.constructor=e;for(var c in f)if($jscomp.global.Object.defineProperties){var l=$jscomp.global.Object.getOwnPropertyDescriptor(f,c);void 0!==l&&$jscomp.global.Object.defineProperty(e,c,l)}else e[c]=f[c]};
...
c;var g={0:function(){},1:function(a){return performance.mark("["+self.constructor.name+"][Client] - "+a)},2:function(a,d){for(var b=[],c=1;c<arguments.length;++c)b[c-1]=arguments[c];console.log.apply(console,[].concat(["[Client]"+("["+self.constructor.name+"]["+location.pathname+"]")+' - "'+a+'"'],$jscomp.arrayFromIterable(b)))}}[0],d=constructor.name;c.prototype={connect:function(){var a=this;g("connect");if(this.connected)return this.connected;g("connecting...",this.service);var b=new MessageChannel;
